...
const HouseViewPage = () => {
  const { houses, isOpen, handleClose, setPath, setIsOpen } = useOutletContext<ContextText>();
  ...
  return (
    <>
      ...
      <GridItem paddingTop={5} paddingRight={5} paddingLeft={5} area="main">
        <Outlet context={{houses, setPath,  isOpen, handleClose, id }} />
        <HomeViewCard setIsOpen = {setIsOpen} setPath = {setPath} isOpen = {isOpen} houses={houses} id={id} />
      </GridItem>
    </>
  );
};
